...
*/
/**************************************************************************/
bool Adafruit_VL53L0X::begin(uint8_t i2c_addr, bool debug, i2c_inst_t *i2c, VL53L0X_Sense_config_t vl_config) {
    ...
    VL53L0X_i2c_init(i2c, SDA_PIN, SCL_PIN, 100 * 1000);
    ...
    if (VL53L0X_IMPLEMENTATION_VER_MAJOR != VERSION_REQUIRED_MAJOR ||
        ...
        if (debug) {
            ...
            // Serial.println(F("Requires " STR(VERSION_REQUIRED_MAJOR) "." STR(VERSION_REQUIRED_MINOR) "." STR(
...
bool Adafruit_VL53L0X::configSensor(VL53L0X_Sense_config_t vl_config) {
    ...
    switch (vl_config) {
        ...
        case VL53L0X_SENSE_LONG_RANGE:
            ...
            Status = VL53L0X_SetLimitCheckValue(pMyDevice, VL53L0X_CHECKENABLE_SIGNAL_RATE_FINAL_RANGE,
                                                (FixPoint1616_t)(0.1 * 65536));
            if (Status == VL53L0X_ERROR_NONE) {
                Status = VL53L0X_SetLimitCheckValue(pMyDevice, VL53L0X_CHECKENABLE_SIGMA_FINAL_RANGE,
        ...
        case VL53L0X_SENSE_HIGH_ACCURACY:
            ...
            if (Status == VL53L0X_ERROR_NONE) {
                Status = VL53L0X_SetLimitCheckEnable(pMyDevice, VL53L0X_CHECKENABLE_RANGE_IGNORE_THRESHOLD, 0);
            }
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::startMeasurement(bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::stopMeasurement(bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    if (Status == VL53L0X_ERROR_NONE) {
        if (debug) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::getLimitCheckCurrent(uint8_t LimitCheckId, FixPoint1616_t *pLimitCheckCurrent,
                                                     bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::setDeviceMode(VL53L0X_DeviceModes DeviceMode, bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    if (Status == VL53L0X_ERROR_NONE) {
        if (debug) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::setInterruptThresholds(FixPoint1616_t ThresholdLow, FixPoint1616_t ThresholdHigh,
                                                       bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    if (Status == VL53L0X_ERROR_NONE) {
        if (debug) {
        ...
        Status = VL53L0X_SetInterruptThresholds(pMyDevice, VL53L0X_DEVICEMODE_CONTINUOUS_RANGING, ThresholdLow,
                                                ThresholdHigh);
    }
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::getInterruptThresholds(FixPoint1616_t *pThresholdLow, FixPoint1616_t *pThresholdHigh,
                                                       bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    if (Status == VL53L0X_ERROR_NONE) {
        if (debug) {
        ...
        // not used but API requires something so pass in
        // VL53L0X_DEVICEMODE_CONTINUOUS_RANGING even though not used
        Status = VL53L0X_GetInterruptThresholds(pMyDevice, VL53L0X_DEVICEMODE_CONTINUOUS_RANGING, pThresholdLow,
                                                pThresholdHigh);
    }
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::getDeviceMode(VL53L0X_DeviceModes *pDeviceMode, bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    if (Status == VL53L0X_ERROR_NONE) {
        if (debug) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::clearInterruptMask(bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    if (Status == VL53L0X_ERROR_NONE) {
        if (debug) {
...
*/
/**************************************************************************/
VL53L0X_Error Adafruit_VL53L0X::setGpioConfig(VL53L0X_DeviceModes DeviceMode, VL53L0X_GpioFunctionality Functionality,
                                              VL53L0X_InterruptPolarity Polarity, bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    if (Status == VL53L0X_ERROR_NONE) {
        if (debug) {
...
VL53L0X_Error Adafruit_VL53L0X::getGpioConfig(VL53L0X_DeviceModes *pDeviceMode,
                                              ...
                                              VL53L0X_InterruptPolarity *pPolarity, bool debug) {
    VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    if (Status == VL53L0X_ERROR_NONE) {
        if (debug) {
...
uint16_t Adafruit_VL53L0X::readRange(void) {
    ...
    if (Status == VL53L0X_ERROR_NONE) return measure.RangeMilliMeter;
...
uint16_t Adafruit_VL53L0X::readRangeResult(void) {
    ...
    _rangeStatus = measure.RangeStatus;
    if (Status == VL53L0X_ERROR_NONE) Status = VL53L0X_ClearInterruptMask(pMyDevice, 0);

    if ((Status == VL53L0X_ERROR_NONE) && (_rangeStatus != 4)) return measure.RangeMilliMeter;
...
bool Adafruit_VL53L0X::startRangeContinuous(uint16_t period_ms) {
    ...
    if (Status == VL53L0X_ERROR_NONE) {
        Status = VL53L0X_SetInterMeasurementPeriodMilliSeconds(pMyDevice, period_ms);
    }
...
*/
/**************************************************************************/
bool Adafruit_VL53L0X::setMeasurementTimingBudgetMicroSeconds(uint32_t budget_us) {
...
uint32_t Adafruit_VL53L0X::getMeasurementTimingBudgetMicroSeconds() {
    uint32_t budget_us;
    Status = VL53L0X_GetMeasurementTimingBudgetMicroSeconds(pMyDevice, &budget_us);
    return (budget_us);
}
...
*/
/**************************************************************************/
bool Adafruit_VL53L0X::setVcselPulsePeriod(VL53L0X_VcselPeriod VcselPeriodType, uint8_t VCSELPulsePeriod) {
    Status = VL53L0X_SetVcselPulsePeriod(pMyDevice, VcselPeriodType, VCSELPulsePeriod);
    return (Status == VL53L0X_ERROR_NONE);
}
 ...
 */
/**************************************************************************/
bool Adafruit_VL53L0X::setLimitCheckEnable(uint16_t LimitCheckId, uint8_t LimitCheckEnable) {
    Status = VL53L0X_SetLimitCheckEnable(pMyDevice, LimitCheckId, LimitCheckEnable);
    return (Status == VL53L0X_ERROR_NONE);
}
...
bool Adafruit_VL53L0X::setLimitCheckValue(uint16_t LimitCheckId, FixPoint1616_t LimitCheckValue) {
...
FixPoint1616_t Adafruit_VL53L0X::getLimitCheckValue(uint16_t LimitCheckId) {
    ...
    Status = VL53L0X_GetLimitCheckValue(pMyDevice, LimitCheckId, &LimitCheckValue);
